...
public:
    ...
    virtual std::vector<Post> searchUserPosts(int userId, const std::string& content) = 0;
    virtual std::vector<Post> getUserFeed(int userId) = 0;

    virtual Post create(int userId, const std::string& content) = 0;
    virtual bool update(int postId, const std::string& content) = 0;
